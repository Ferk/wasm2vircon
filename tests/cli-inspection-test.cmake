...
function(read_cli_case case_directory prefix)
  ...
  endforeach()
  foreach(field IN ITEMS source entry role profile_expectations skip_error_expectations)
...
function(assemble_cli_fixture case_directory wasm_file prefix)
  ...
  foreach(field IN ITEMS entry profile_expectations skip_error_expectations)
...
if(embedded_normalizer EQUAL -1)
  require_fragment("external normalization hint" "${rejected_error}"
    "raw clang/wasm-ld output may need the supported cleanup profile")
  require_fragment("external normalization hint" "${rejected_error}"
    "scripts/normalize-virconwasm.sh")
else()
  string(FIND "${help_error}" "normalizer; raw clang/wasm-ld output" incorrect_hint)
  if(NOT incorrect_hint EQUAL -1)
    message(FATAL_ERROR "embedded build printed an external-normalization hint")
  endif()
endif()
