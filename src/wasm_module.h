...
typedef enum WasmValueType {
    WASM_VALUE_NONE, WASM_VALUE_I32, WASM_VALUE_F32, WASM_VALUE_I64,
    WASM_VALUE_OTHER
} WasmValueType;
typedef enum WasmExprKind {
    ...
    WASM_EXPR_I64_WORD_EXTRACT, WASM_EXPR_I64_LOAD_STORE_LOCAL_TEE,
    WASM_EXPR_I64_LOCAL_WORD_EXTRACT, WASM_EXPR_I64_LOCAL_TEE_WORD_EXTRACT,
...
typedef enum WasmBinaryOp {
    ...
    WASM_BINARY_LE_U, WASM_BINARY_OR, WASM_BINARY_REM_U,
